...
describe('Game time UI', () => {
  it('renders accessible speeds, Step policy, calendar, and lifecycle counts', () => {
    document.body.innerHTML =
      '<main><section class="game-hud"><details class="secondary-controls"></details></section></main>';
    const onSpeed = vi.fn();
    const onStep = vi.fn();
    ...
    expect(document.querySelector('[data-testid="game-calendar"]')?.textContent).toBe(
      'Y1 M1 D2 06:00',
    );
    ui.playButton.click();
