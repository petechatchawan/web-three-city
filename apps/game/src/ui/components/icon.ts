...
const iconPaths: Readonly<Record<CityIconName, readonly string[]>> = {
  ...
  population: [
    'M8 11A3 3 0 1 0 8 5A3 3 0 0 0 8 11Z',
    'M16 10A2.5 2.5 0 1 0 16 5A2.5 2.5 0 0 0 16 10Z',
    'M3 20C3 16.5 5 14 8 14C11 14 13 16.5 13 20',
    'M13 14C16.8 13 20 15.2 20 19',
  ],
  treasury: [
    'M4 9 12 4 20 9',
    'M5 10H19',
