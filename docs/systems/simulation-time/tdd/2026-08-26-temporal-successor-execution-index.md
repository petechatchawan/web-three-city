...
3. Playback migration **retains the merged nominal pacing** for this architecture cutover: x1 `1.000s`, x2 `0.500s`, x4 `0.250s` per GameMinute. The rejected `3.000/1.500/0.750` proposal would be three times slower. Any future faster/slower tuning is a separate product decision.
...
| T4 | Simulation calendar/playback | `2026-08-26-t4-compressed-calendar-playback.md` | calendar rollover + unchanged pacing GREEN |
| T5 | World persistence | `../../world/tdd/2026-08-26-world-save-v9-temporal-calendar-migration.md` | V1-V8 golden migration + V9 roundtrip GREEN |
