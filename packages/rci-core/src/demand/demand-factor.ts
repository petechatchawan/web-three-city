  ...
  Object.freeze([
    Object.freeze({
      ...
      evaluate: (context: RciDemandFactorContext) =>
        clampDemandMilli(
          ratioPressure(context.unemployedResidentCount, Math.max(1, context.workingAgeResidentCount)) -
            ratioPressure(context.commercialVacantPositionCount, Math.max(1, context.commercialPositionCapacity)),
        ),
    }),
    Object.freeze({
    ...
    Object.freeze({
      ...
      evaluate: (context: RciDemandFactorContext) =>
        clampDemandMilli(
          ratioPressure(context.unemployedResidentCount, Math.max(1, context.workingAgeResidentCount)) -
            ratioPressure(context.industrialVacantPositionCount, Math.max(1, context.industrialPositionCapacity)),
        ),
    }),
    Object.freeze({
