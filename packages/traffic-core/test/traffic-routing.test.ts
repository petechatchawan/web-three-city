...
const graph: TrafficGraph = Object.freeze({
  ...
  edges: Object.freeze([
    { edgeId: 'ab', fromNodeId: 'A', toNodeId: 'B', mode: 'Drive', lengthQ: 1000, freeFlowTravelSeconds: 10, capacityUnits: 10 },
    { edgeId: 'bd', fromNodeId: 'B', toNodeId: 'D', mode: 'Drive', lengthQ: 1000, freeFlowTravelSeconds: 10, capacityUnits: 10 },
    { edgeId: 'ac', fromNodeId: 'A', toNodeId: 'C', mode: 'Drive', lengthQ: 1000, freeFlowTravelSeconds: 10, capacityUnits: 10 },
    { edgeId: 'cd', fromNodeId: 'C', toNodeId: 'D', mode: 'Drive', lengthQ: 1000, freeFlowTravelSeconds: 10, capacityUnits: 10 },
  ]),
});
