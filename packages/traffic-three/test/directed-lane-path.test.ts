...
import type { TrafficRouteSegment } from '../src/index.js';
...
describe('PR3 directed lane path', () => {
  ...
  it('derives a continuous right-turn connector inside the junction envelope', () => {
    ...
    expect(connector).toHaveLength(4);
