...
function system(
  name: string,
  source = "export interface View { readonly id: string; }\n",
  options: Parameters<typeof packageJson>[1] = {},
): FileMap {
  return {
    [`systems/${name}/package.json`]: packageJson(
      `@web-three-city/${name}`,
      options,
    ),
...
function scenarioFiles(scenario: string): FileMap {
  switch (scenario) {
    case "minimal-foundation":
      return root({
        "foundation/contracts/package.json": packageJson(
    ...
    case "approved-system-read":
      return root({
        ...system(
          "beta",
          "export interface BetaView { readonly id: string; }\n",
        ),
        ...system(
          "alpha",
          "import type { BetaView } from '@web-three-city/beta';\nexport type AlphaView = BetaView;\n",
          {
        ...
        "architecture.policy.json": JSON.stringify(
          {
            ...
            approvedSystemReadEdges: [
              {
                from: "@web-three-city/alpha",
                to: "@web-three-city/beta",
                reference: "fixture-spec",
              },
            ],
            approvedSameLayerEdges: [],
            packageNameDeviations: [],
    ...
    case "repository-test-public-surfaces":
      return root({
        ...system(
          "alpha",
          "export interface AlphaView { readonly id: string; }\n",
          {
            exports: {
              ".": "./src/index.ts",
        ...
        "systems/alpha/src/commands.ts":
          'export interface AlphaCommand { readonly type: "alpha"; }\n',
        "systems/alpha/src/composition.ts":
          "export function createAlpha(): object { return {}; }\n",
        "tests/integration/alpha.ts":
          "import type { AlphaCommand } from '@web-three-city/alpha/commands';\nimport { createAlpha } from '@web-three-city/alpha/composition';\nexport const fixture: [AlphaCommand, object] = [{ type: 'alpha' }, createAlpha()];\n",
      });
    ...
    case "foundation-dependency":
      return root({
        "foundation/base/package.json": packageJson(
          "@web-three-city/foundation-base",
        ),
        "foundation/base/src/index.ts":
          "export interface BaseValue { readonly value: string; }\n",
        "foundation/upper/package.json": packageJson(
          "@web-three-city/foundation-upper",
          {
            dependencies: { "@web-three-city/foundation-base": "workspace:*" },
          },
        ),
        "foundation/upper/src/index.ts":
          "import type { BaseValue } from '@web-three-city/foundation-base';\nexport type UpperValue = BaseValue;\n",
      });
    ...
    case "package-name-mismatch":
      return root({
        "systems/alpha/package.json": packageJson(
          "@web-three-city/system-alpha",
        ),
    ...
    case "relative-deep-import":
      return root({
        ...
        "apps/game/package.json": packageJson("@web-three-city/app-game"),
        "apps/game/src/index.ts":
          "import '../../../systems/alpha/src/index';\n",
      });
    case "undeclared-dependency":
      return root({
        ...
        "apps/game/package.json": packageJson("@web-three-city/app-game"),
        "apps/game/src/index.ts":
          "import type { View } from '@web-three-city/alpha';\nexport type AppView = View;\n",
      });
    case "dev-only-production-dependency":
      return root({
        ...system("alpha"),
        "apps/game/package.json": packageJson("@web-three-city/app-game", {
          devDependencies: { "@web-three-city/alpha": "workspace:*" },
        }),
        "apps/game/src/index.ts":
          "import type { View } from '@web-three-city/alpha';\nexport type AppView = View;\n",
      });
    case "unapproved-system-read":
      return root({
        ...
        ...system(
          "alpha",
          "import type { View } from '@web-three-city/beta';\nexport type AlphaView = View;\n",
          {
            dependencies: { "@web-three-city/beta": "workspace:*" },
          },
        ),
    ...
    case "system-command":
      return root({
        ...
        "systems/beta/src/commands.ts":
          'export interface BetaCommand { readonly type: "beta"; }\n',
        ...system(
          "alpha",
          "import type { BetaCommand } from '@web-three-city/beta/commands';\nexport type Command = BetaCommand;\n",
          { dependencies: { "@web-three-city/beta": "workspace:*" } },
        ),
      });
    case "system-composition":
      return root({
        ...
        "systems/beta/src/composition.ts":
          "export function createBeta(): object { return {}; }\n",
        ...system(
          "alpha",
          "import { createBeta } from '@web-three-city/beta/composition';\nexport const beta = createBeta();\n",
          { dependencies: { "@web-three-city/beta": "workspace:*" } },
        ),
      });
    case "system-query-cycle":
      return root({
        ...system(
          "alpha",
          "import type { View as BetaView } from '@web-three-city/beta';\nexport type AlphaView = BetaView;\n",
          { dependencies: { "@web-three-city/beta": "workspace:*" } },
        ),
        ...system(
          "beta",
          "import type { AlphaView } from '@web-three-city/alpha';\nexport type View = AlphaView;\n",
          { dependencies: { "@web-three-city/alpha": "workspace:*" } },
        ),
        "architecture.policy.json": JSON.stringify(
          {
            ...
            approvedSystemReadEdges: [
              ...
              {
                from: "@web-three-city/beta",
                to: "@web-three-city/alpha",
                reference: "fixture-b",
              },
            ],
            approvedSameLayerEdges: [],
    ...
    case "orchestration-composition":
      return root({
        ...
        "systems/alpha/src/composition.ts":
          "export function createAlpha(): object { return {}; }\n",
        "orchestration/build/package.json": packageJson(
          "@web-three-city/orchestration-build",
          { dependencies: { "@web-three-city/alpha": "workspace:*" } },
        ),
        "orchestration/build/src/index.ts":
          "import { createAlpha } from '@web-three-city/alpha/composition';\nexport const alpha = createAlpha();\n",
      });
    case "testkit-command":
      return root({
        ...
        "systems/alpha/src/commands.ts":
          'export interface AlphaCommand { readonly type: "alpha"; }\n',
        "testkit/helpers/package.json": packageJson(
          "@web-three-city/testkit-helpers",
          { dependencies: { "@web-three-city/alpha": "workspace:*" } },
        ),
        "testkit/helpers/src/index.ts":
    ...
    case "contract-port-leak":
      return root({
        ...system(
          "alpha",
          "export type { PublicQuery } from './contracts/public';\n",
        ),
        "systems/alpha/src/contracts/public.ts":
          "import type { SecretPort } from '../ports/secret';\nexport interface PublicQuery { readonly port: SecretPort; }\n",
        "systems/alpha/src/ports/secret.ts":
          "export interface SecretPort { read(): string; }\n",
      });
    case "domain-three":
      return root({
        ...system("alpha"),
        "systems/alpha/package.json": packageJson("@web-three-city/alpha", {
          dependencies: { three: "0.179.1" },
        }),
        "systems/alpha/src/domain/model.ts":
    ...
    case "domain-outer-layer":
      return root({
        ...
        "systems/alpha/src/application/run.ts":
...
export async function materializeFixture(scenario: string): Promise<string> {
  const rootDir = await mkdtemp(
    path.join(tmpdir(), "web-three-city-architecture-"),
  );
