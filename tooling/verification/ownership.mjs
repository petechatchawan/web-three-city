...
export const OWNERSHIP = Object.freeze({
  'world-core': createOwner(
    'world-core',
    VerificationRisk.PARTIAL,
    [],
    [
      'terrain-core',
      'road-core',
  ...
  'terrain-generator': createOwner(
    'terrain-generator',
    VerificationRisk.PARTIAL,
    [],
    ['game', 'terrain-lab'],
  ),
  'terrain-three': createOwner(
    'terrain-three',
    VerificationRisk.GRAPH_SAFE,
    ['@terrain'],
    ['game', 'terrain-lab'],
  ),
  'road-core': createOwner(
    'road-core',
    VerificationRisk.PARTIAL,
    ['@road'],
    ['road-three', 'game', 'terrain-lab'],
  ),
  'road-three': createOwner(
    'road-three',
    VerificationRisk.GRAPH_SAFE,
    ['@road'],
    ['game', 'terrain-lab'],
  ),
  'water-core': createOwner(
    'water-core',
    VerificationRisk.PARTIAL,
    ['@water'],
    ['water-three', 'game', 'terrain-lab'],
  ),
  'water-three': createOwner(
    'water-three',
    VerificationRisk.GRAPH_SAFE,
    ['@water'],
    ['game', 'terrain-lab'],
  ),
  'zone-core': createOwner(
    'zone-core',
    VerificationRisk.PARTIAL,
    ['@zoning'],
    ['building-core', 'rci-core', 'zone-three', 'game'],
  ),
  'zone-three': createOwner('zone-three', VerificationRisk.GRAPH_SAFE, ['@zoning'], ['game']),
  'building-core': createOwner(
    'building-core',
    VerificationRisk.PARTIAL,
    ['@building'],
    ['rci-core', 'building-three', 'game'],
  ),
  'building-three': createOwner(
    'building-three',
    VerificationRisk.GRAPH_SAFE,
    ['@building'],
    ['game'],
  ),
  'simulation-core': createOwner(
    'simulation-core',
    VerificationRisk.PARTIAL,
    [],
    ['building-core', 'rci-core', 'game'],
  ),
  ...
  'citizen-mobility-core': createOwner(
    'citizen-mobility-core',
    VerificationRisk.PARTIAL,
    [],
    ['traffic-core', 'game'],
  ),
  'traffic-core': createOwner(
    'traffic-core',
    VerificationRisk.PARTIAL,
    [],
    ['traffic-three', 'game'],
  ),
  'traffic-three': createOwner(
    'traffic-three',
    VerificationRisk.GRAPH_SAFE,
    ['@traffic'],
    ['game'],
  ),
  'camera-input': createOwner(
    'camera-input',
    VerificationRisk.GRAPH_SAFE,
    ['@interaction'],
    ['game', 'terrain-lab'],
  ...
  game: createOwner(
    'game',
    VerificationRisk.GRAPH_BLIND,
    ['@traffic', '@road', '@building', '@rci', '@interaction'],
    [],
    {
...
const GAME_SOURCE_RULES = Object.freeze([
  {
    pattern:
      /^apps\/game\/src\/(?:traffic-presentation|traffic-runtime-presentation|traffic-presentation-projection|traffic-information-view|traffic-inspect-target)\.ts$/,
    browserTags: ['@traffic'],
  ...
  {
    pattern:
      /^apps\/game\/src\/(?:traffic-transport-transaction|traffic-source-projection|traffic-road-reconciliation|traffic-graph-cache|mobility-traffic-tick|mobility-traffic-state-registry|rci-building-reconciliation|economy-tax-policy-command|traffic-release-fixture|traffic-performance-release-fixture)\.ts$/,
    browserTags: [],
